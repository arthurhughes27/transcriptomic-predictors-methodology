...
# 03_compare_model_genewise.R scripts (via
# R/metrics_io.R::save_comparison_metrics(..., subdir = "supplementary"))
# into a single, long-format data frame spanning every dataset and
# (supplementary) category, and cache it for downstream cross-dataset
# visualisation.
#
...
# ("engineering_genewise", "selection_genewise", "model_genewise"), and
# comparison.
#
