# analysis/supplementary/sdy1276_tiv/02_compare_selection_genewise.R
#
...
# 01_compare_engineering_genewise.R) via analysis/supplementary/sdy1276_tiv/00_master.R,
...
# reduction (computed once on paired$X, not recomputed per CV fold) that
...
paired$X <- prefilter_by_variance(paired$X)
...
save_comparison_metrics(res_genewise, dataset = "sdy1276_tiv", category = "selection_genewise", subdir = "supplementary")
