...
# (04_find_best_model_genewise.R). Not sourced by analysis/pipeline_comparisons/sdy1276_tiv/00_master.R or
...
source(fs::path("analysis", "supplementary", "sdy1276_tiv", "03_compare_model_genewise.R"))

gc()

source(fs::path("analysis", "supplementary", "sdy1276_tiv", "04_find_best_model_genewise.R"))
