...
# siblings 02_compare_selection_genewise.R/03_compare_model_genewise.R) via
# analysis/supplementary/sdy1276_tiv/00_master.R, or
...
# (day 0) and day-1 expression per participant, so this comparison uses the
