# analysis/supplementary/prevac_ad26mva/00_master.R
#
# Master script for prevac_ad26mva's SUPPLEMENTARY (gene-wise) comparisons only - runs
...
# analysis/pipeline_comparisons/prevac_ad26mva/00_master.R or
...
# analysis/pipeline_comparisons/prevac_ad26mva/01_prepare_data.R (data preparation
...
source(fs::path("analysis", "supplementary", "prevac_ad26mva", "01_compare_engineering_genewise.R"))

gc()

source(fs::path("analysis", "supplementary", "prevac_ad26mva", "02_compare_selection_genewise.R"))

gc()

source(fs::path("analysis", "supplementary", "prevac_ad26mva", "03_compare_model_genewise.R"))

gc()

source(fs::path("analysis", "supplementary", "prevac_ad26mva", "04_find_best_model_genewise.R"))
