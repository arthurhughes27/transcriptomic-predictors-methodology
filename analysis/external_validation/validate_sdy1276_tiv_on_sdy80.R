...
# data/derived/best_pipeline_sdy1276_tiv.rds exists.
...
discovery <- readRDS(fs::path(derived_data_dir, "sdy1276_tiv_analysis_data.rds"))
best <- readRDS(fs::path(derived_data_dir, "best_pipeline_sdy1276_tiv.rds"))
...
saveRDS(fit, file = fs::path(derived_data_dir, "validation_fit_sdy1276_tiv_on_sdy80.rds"))
