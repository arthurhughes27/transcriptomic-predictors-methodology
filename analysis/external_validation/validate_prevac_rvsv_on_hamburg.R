...
# data/derived/best_pipeline_prevac_rvsv.rds exists.
...
discovery <- readRDS(fs::path(derived_data_dir, "prevac_rvsv_analysis_data.rds"))
best <- readRDS(fs::path(derived_data_dir, "best_pipeline_prevac_rvsv.rds"))
...
saveRDS(fit, file = fs::path(derived_data_dir, "validation_fit_prevac_rvsv_on_hamburg.rds"))
