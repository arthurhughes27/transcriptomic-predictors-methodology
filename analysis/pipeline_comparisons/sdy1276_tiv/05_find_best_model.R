...
# no saved result exists yet at derived_data_dir/best_pipeline_sdy1276_tiv.rds
...
best_path <- fs::path(derived_data_dir, "best_pipeline_sdy1276_tiv.rds")
best_fit_path <- fs::path(derived_data_dir, "best_model_fit_sdy1276_tiv.rds")
