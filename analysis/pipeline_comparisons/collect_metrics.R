...
# ("engineering", "selection_geneset", "selection_genewise", "model"), and
# comparison (identifies which specific compare_pipelines() call a row came
# from - see R/metrics_io.R for why this can differ from category, e.g.
# sdy1276_tiv's "engineering" category spans two comparisons).
#
