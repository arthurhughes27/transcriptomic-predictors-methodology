...
# day-180 antibody titer from day-7 gene expression.
#
...
# `treatment == 1` (rVSV) vs. `treatment == 0` (placebo); dearseq's default
# `dearseq_mode = "classic"` does the same. Neither needs
